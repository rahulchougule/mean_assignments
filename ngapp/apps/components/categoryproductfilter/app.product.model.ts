// Product model : to define structure and initialise 
export class Product {
    constructor(
        public ProdId: number, // public so that they can be accessed outside
        public ProdName: string,
        public CatId: number
    ) { }
}
 
export const Products: Array<Product> = new Array<Product>();  // by default product values
